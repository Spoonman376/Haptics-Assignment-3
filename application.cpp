...
/*
    ...
    You may use this program as a boilerplate for starting assignment #3.

    Additional files containing a custom subclass of cMultiMesh that loads
    and visually renders unstructured point data are provided. You will likely
    write most of your code in the PointSet class, or another class you create
    and add to the project, for this homework assignment.
...
/*
    ...
    type PointSet, which loads the point data from the file p1-ledge.ply.
    If the file fails to load, ensure that the paths are set correctly, and
    change them if needed. The implementation of the force rendering algorithm
    must be completed in the PointSet class before the object can be touched.
*/
//==============================================================================
...
int main(int argc, char* argv[])
{
    ...
    cout << "Assignment #3: Point Set Surfaces" << endl;
    ...
    /////////////////////////////////////////////////////////////////////////
    // [CPSC.86] POINT SET SURFACE OBJECT(S)
    /////////////////////////////////////////////////////////////////////////
